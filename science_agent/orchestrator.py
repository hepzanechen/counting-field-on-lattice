...
def run_full_cycle(conjecture: str, experiment_runner, model_catalog_text: str,
    ...
    for exp in experiments:
        results, judge_report, measured = experiment_runner(hypothesis.model,
                                                             exp["params"])
        evidence_entry = {
