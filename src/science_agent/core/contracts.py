...
class EvidenceEntry:
    ...
    judge_report: list[dict[str, object]]
    verdict: str
    timestamp: float = 0.0
    source: str = ""
...
class LiteratureMap:
    hypothesis_id: str
    supporting: list[dict[str, object]] = field(default_factory=list)
    contradicting: list[dict[str, object]] = field(default_factory=list)
...
ROLE_DIMENSIONS: dict[str, dict[str, str]] = {
